window.addEventListener("load", (e) => {
    ...
    if(document.getElementById('subtype').value==='Sale' || document.getElementById('subtype').value==='Resale'){
        ...
        const usuarios_registradores = [
            ...
            { area: 'MARKETING', usuario: 'LINCOLN GIAMPIERRE ZAMUDIO CASTILLO', correo: 'lzamudio@biomont.com.pe', idusuario: '24738', idrol: '1120', idrevisador: '', necesita_revision: false },
            { area: 'MARKETING', usuario: 'JEAN FRANCO ALCANTARA RODRIGUEZ', correo: 'jalcantara@biomont.com.pe', idusuario: '27817', idrol: '1120', idrevisador: '', necesita_revision: false },
            ...
            { area: 'FINANZAS', usuario: 'ALBINA ROSA YARINGAÑO PIZARRO', correo: 'ayaringano@biomont.com.pe', idusuario: '170', idrol: '1120', idrevisador: '', necesita_revision: false },
        ];
        ...
        const usuarios_revisadores = [
            ...
            { usuario: 'EDISON RONALD VERA VASQUEZ', correo: 'evera@biomont.com.pe', idusuario: '298', idrol: '1076', correos_adicionales: ['kmuga@biomont.com.pe','lgomez@biomont.com.pe','analistascc@biomont.com.pe','selias@biomont.com.pe'] },
            { usuario: 'MELISSA PIMENTEL MEJIA', correo: 'mpimentel@biomont.com.pe', idusuario: '300', idrol: '1090', correos_adicionales: ['mantenimiento@biomont.com.pe', 'srodriguez@biomont.com.pe'] },
