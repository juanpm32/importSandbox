window.addEventListener("load", (e) => {
    ...
    if (document.getElementById('subtype').value === 'Sale' || document.getElementById('subtype').value === 'Resale') {
        ...
        const usuarios_revisadores = [
            ...
            { nomusuario: 'DENIS BETTY ALAYO MERGILDO', correo: 'dalayo@biomont.com.pe', idusuario: '276', idrol: '1082', nomrol: 'BIO_ROL_ADMINISTRACION', correos_adicionales: ['dalayo@Biomont.com.pe','adurand@Biomont.com.pe', 'avilchez@biomont.com.pe', 'kcelestino@biomont.com.pe', 'lbasualdo@biomont.com.pe'] },
                            ...
                            fetch(BASE_URL + "/correlativoarticulo/updateCorrelativoLineaArticulo", {
                                ...
                                .then((data) => {
                                    ...
                                    if (data.res) {
                                        ...
                                        alert("Correlativo actualizado correctamente, se envió correo de creación");
